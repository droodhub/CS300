...
public class Pokemon implements Comparable<Pokemon> {
   ...
   * 
   * @param combatPower CP value represents a function of combination of its attack, stamina and
   *                    defense stats
   * @throws IllegalArgumentException if the format of the combatPower is incorrect.
   */
  ...
  /**
   * Returns a String representation of this Pokemon For instance "[Pikachu CP:123 (A:1 S:2 D:3)]"
   * 
   ...
   * 
   * @returns the value 0 if the argument otherPokemon has the same CP value as this Pokemon; a
   *          value less than 0 if this Pokemon is less powerful than the otherPokemon; and a value
   *          greater than 0 if this Pokemon is more powerful than otherPokemon.
   */
  @Override
