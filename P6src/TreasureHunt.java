...
public class TreasureHunt extends PApplet {
  ...
  public static void main(String[] args) {
    ...
    // do not add any other statement to your TreasureHunt.main() method}
  }
  ...
  public void setup() {
    ...
    getSurface().setTitle("Treasure Hunt");
...
/**
    ...
    ClickableObject koala = new ClickableObject("koala", 360, 65, a);
    VisibleObject chest = new VisibleObject("chest", 365, 400);
    VisibleObject phone = new VisibleObject("phone", 700, 490);
    phone.deactivate();
    Action b = new Action("Open sesame!", phone);
    DroppableObject key = new DroppableObject("key", 70, 70, chest, b);
  ...
  public void draw() {
    ...
    for (int i = 0; i < gameObjects.size(); i++) {
      Action a = gameObjects.get(i).update();
      if (a != null)
        a.act(gameObjects);
    }
